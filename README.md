...
| hwupload_vpe | filter  | VeriSilicon Hardware Uploader  for UYVY422                                                                                | Upload raw data to hardware encoders. <br>Suppported raw data format:<br> UYVY422                        |
...
```bash
./ffmpeg -y -init_hw_device vpe=dev0:/dev/transcoder0 -c:v h264_vpe -transcode 1 -i ${INPUT_FILE_H264} -c:v h264enc_vpe out0.h264
```
...
|                    | gop_lowdelay     | int    | Enable default lowDelay GOP configuration. If --gopConfig not specified, only valid for GOP size <= 4 | [0..1]                                                                                                                                                                           | 0                          |
